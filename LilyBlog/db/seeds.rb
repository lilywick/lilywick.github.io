...
test_colors = Color.create([{color_name: "Red"}, {color_name: "blue"}, {color_name: "green"}, {color_name: "black"}, {color_name: "white"}, {color_name: "pink"}, {color_name: "yellow"}, {color_name: "orange"}, {color_name: "purple"}])
